...
ALTER TABLE `employee` ADD COLUMN `mobile` VARCHAR(15) NOT NULL AFTER `name`;
ALTER TABLE `employee` ADD COLUMN `image` VARCHAR(255) NULL AFTER `doj`;
...
ALTER TABLE `cities` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=604;

ALTER TABLE `cities` RENAME TO  `city` ;


ALTER TABLE `states` ADD PRIMARY KEY (`id`);
ALTER TABLE `states` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36;
...
CREATE TABLE `salary` ( 
  ...
  `month` INT NOT NULL,
  `year` YEAR NOT NULL,
  `attendance_hours` FLOAT NOT NULL,
  `holidays` INT NOT NULL,
  `leaves` FLOAT NOT NULL,
  `present_days` FLOAT NOT NULL,
  `declare_salary` FLOAT NOT NULL,
  `cal_salary` FLOAT NOT NULL,
