jQuery.fn.extend({
    browseProductGallery : function (obj)
    {
        ...
        return this.each(function()
        {
            ...
            var btn = "<div><span class='product-gallery-files-info' style='margin-left:5px;'></span><div>";
            
            $(this).parent().append(btn);

            var browseBtn = $(this).parent().find(".product-gallery-browse").first();
            
            var modal_id = 'product-gallery-modal-' + obj.postfix;
                    ...
                    html += '<div class="modal-dialog">';
                        html += '<div class="modal-content">';
                            html += '<div class="modal-header">';
                                html += '<h5 class="modal-title">Product Gallery</h5>';
            ...
            var file_info = $(this).parent().find(".product-gallery-files-info");
            ...
            {
                $(gallery_modal).find(".modal-body").load("/admin/products_gallery", {value : value, multiple : multiple});
